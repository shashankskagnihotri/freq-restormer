...
from basicsr.utils import (MessageLogger, check_resume, get_env_info,
                           ...
                           set_random_seed, save_images, hist_plot)
...
def parse_options(is_train=True):
    ...
    parser.add_argument('--attack_iterations', type=int, default=0)
    ...
    parser.add_argument('--debugging', action="store_true", help="training the model to test")
    parser.add_argument('--is_val', action="store_true", help="Only validate the model")
    parser.add_argument('--adv_attack', action="store_true", help="Adversarially attack the model")
    parser.add_argument('--flc', action="store_true", help="use FLC Pooling while training the model")
    ...
    parser.add_argument('--pretrain_network_g', type=str, default=None)
    ...
    opt = parse(args.opt, is_train=is_train, args=args)
